...
func actionGroup(a ui.Action) (int, string) {
	...
	case strings.HasPrefix(c, "vm guest-agent ") || c == "vm console show" || c == "vm set" || c == "vm boot set" || c == "vm autostart" || c == "vm disk grow" || c == "vm disk add" || c == "vm clone" || strings.HasPrefix(c, "guest recipe ") || strings.HasPrefix(c, "guest tools "):
