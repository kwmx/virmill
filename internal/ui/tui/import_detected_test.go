...
func TestImportDiskPageExplainsPreparationAndPlacesFormatBehindAdvanced(t *testing.T) {
	...
	view := f.View(80, 24)
	for _, text := range []string{"Review the disks. One review then covers creating and starting the VM.", "Selected VM: 2 CPUs", "8192 MiB RAM", "Preview image preparation", "122880"} {
