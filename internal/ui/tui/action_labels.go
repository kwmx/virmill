...
var actionText = map[string]struct{ label, description string }{
	...
	"import prepare":                {"OVA appliance", "Choose an OVA and import settings. Make independent disk copies."},
	"import prepare-disks":          {"Existing disk images", "Choose a source folder and disk mapping. Copy the selected disks."},
	"import prepare-install":        {"ISO installer", "Choose an ISO and disk settings. Prepare a fresh installation."},
