...
var Actions = []Action{
	...
	{"operation dispose-disk-addition", "vm.disk.add.dispose", "Jobs", "Close an unresolved disk addition by accepting the new disk or deleting its unused volume", "id", "dispose-disk-addition"},
