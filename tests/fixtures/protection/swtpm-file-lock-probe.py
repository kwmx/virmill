...
def lock_refusal(code, output, path):
    ...
    prefix = ("SWTPM_NVRAM_LinearFile_Lock: Could not lock backend-uri file://" +
...
def native(args):
    report = {"fixture": "swtpm-file-lock-probe-v1", "nativeProbeExecuted": False,
...
class SelfTests(unittest.TestCase):
    ...
    def test_refusal_requires_exact_path_and_reason(self):
        ...
        good = ("SWTPM_NVRAM_LinearFile_Lock: Could not lock backend-uri file://" +
...
def self_test():
    ...
    print(report_bytes({"fixture": "swtpm-file-lock-probe-v1", "mode": "self-test",
